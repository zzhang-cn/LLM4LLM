...
### Visual Resources
- [Word Embedding Space](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-3/kp2-embedding-space.html) - Interactive visualization of word vectors in 2D space
- [Bengio Neural Language Model](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-3/kp3-bengio-model.html) - Explore neural language model architecture
