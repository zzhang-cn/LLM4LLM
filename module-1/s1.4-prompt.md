...
- **[3Blue1Brown - "Gradient Descent, How Neural Networks Learn"](https://www.3blue1brown.com/lessons/gradient-descent)** - Outstanding visual explanation of training and cost functions
- **[3Blue1Brown - "Backpropagation Calculus"](https://www.3blue1brown.com/lessons/backpropagation)** - Mathematical foundation of neural network training

### External Interactive Tools
- **[TensorFlow Playground](https://playground.tensorflow.org/)** - Watch neural networks train in real-time and see loss curves
- **[Loss Landscape Visualizer](https://losslandscape.com/)** - Interactive exploration of optimization challenges
- **[Neural Network Training Animation](https://machinelearningknowledge.ai/animated-explanation-of-feed-forward-neural-network-architecture/)** - Animated explanation of forward pass and backpropagation

### Research References
- **[Bengio et al. (2003) Training Results](https://www.jmlr.org/papers/volume3/bengio03a/bengio03a.pdf)** - Original paper showing neural LM performance vs n-grams
- **[Perplexity Comparison Charts](https://web.stanford.edu/~jurafsky/slp3/)** - Academic benchmarks and evaluation metrics
