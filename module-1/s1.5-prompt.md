...
- **Visual Reference**: [Interactive Word2Vec Architecture Demo](../../module-1/session-1-5/kp2-word2vec-demo.html) - Compare Skip-gram and CBOW architectures with interactive demonstrations
...
- **Visual Reference**: [Vector Analogy Solver](../../module-1/session-1-5/kp4-analogy-solver.html) - Solve word analogies with vector arithmetic: king - man + woman = ?
...
- **Visual Reference**: [Polysemy Problem Demo](../../module-1/session-1-5/kp6-polysemy-demo.html) - See how static embeddings struggle with words that have multiple meanings
