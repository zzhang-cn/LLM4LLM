...
![Supervised vs Unsupervised Learning](/api/placeholder/600/300)
...
![Word2Vec Architectures](/api/placeholder/600/300)
...
- **Visual Reference**: [Context Window Training Demo](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-5/kp3-context-training.html) - Interactive exploration of how Word2Vec learns from context windows with negative sampling

![Context Window and Negative Sampling](/api/placeholder/600/300)
...
- **Visual Reference**: [Vector Analogy Solver](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-5/kp4-analogy-solver.html) - Solve word analogies with vector arithmetic: king - man + woman = ?

![Word Vector Relationships](/api/placeholder/600/300)
...
![Word Embedding Applications](/api/placeholder/600/300)
...
- **Visual Reference**: [Polysemy Problem Demo](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-5/kp6-polysemy-demo.html) - See how static embeddings struggle with words that have multiple meanings
