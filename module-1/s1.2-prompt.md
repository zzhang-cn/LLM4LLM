...
- **🎮 Interactive Exploration**: [N-gram Builder](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-2/kp1-ngram-builder.html) - Build n-grams from text and see how prediction quality changes with context size
...
- **🎮 Interactive Exploration**: [Sparsity Explorer](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-2/kp7-sparsity-explorer.html) - Visualize how n-gram coverage drops exponentially as sequence length increases
...
- [N-gram Builder](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-2/kp1-ngram-builder.html): Build n-grams from text and see prediction quality changes
- [Sparsity Explorer](https://zzhang-cn.github.io/LLM4LLM/module-1/session-1-2/kp7-sparsity-explorer.html): Visualize exponential growth and coverage problems
