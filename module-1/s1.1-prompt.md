...
- **🎮 Interactive Exploration**: [Word Frequency Explorer](session-1-1/kp2-word-frequency.html) - Discover how word frequencies follow power law patterns in real text
...
- **🎮 Interactive Exploration**: [Question-Answer Patterns Demo](session-1-1/kp3-qa-patterns.html) - See how the same prediction mechanism handles both text completion and question answering
...
- Word Frequency Explorer: Explore power law distributions in language
- Question-Answer Patterns: See how prediction enables conversation
